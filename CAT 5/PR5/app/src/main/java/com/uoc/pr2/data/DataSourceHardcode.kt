...
class DataSourceHardcode : DataSource {
    ...
    override fun selectItems(id: Int) {
        ...
        if (id == 1) seminarItemList.addAll(ItemsHardcodeSeminary1())
        else if (id == 2) seminarItemList.addAll(ItemsHardcodeSeminary2())
        else if (id == 3) seminarItemList.addAll(ItemsHardcodeSeminary3())
