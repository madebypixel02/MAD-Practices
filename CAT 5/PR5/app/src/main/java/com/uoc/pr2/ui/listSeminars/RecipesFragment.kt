...
import com.uoc.pr2.databinding.FragmentListRecipesBinding


class DiciplinesFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding = FragmentListRecipesBinding.inflate(inflater)


        seminarsAdapter = SeminarsAdapter { d -> adapterOnClick(d) }

        seminarsAdapter.context = context!!
