...
import com.uoc.pr2.ui.list.SeminarFragment
...
class MainActivity : AppCompatActivity(), LoginFragment.OnFragmentLoginInteractionListener {
    ...
    var disciplines_fragment: SeminarFragment? = null
    ...
    //    dataSource.selectItemsDiscipline(0)
...
/*
  ...
  */
    ...
    fun LoginOK2()
    {
        ...
        if(disciplines_fragment==null) {
            disciplines_fragment = SeminarFragment.Companion.newInstance()
        }


        supportFragmentManager.commit {

            replace(R.id.placeholder1, disciplines_fragment!!)
            setTransition(FragmentTransaction.TRANSIT_FRAGMENT_FADE)
            addToBackStack(null)
