...
class DataSourceHardcode:DataSource {
    ...
    // ****************************************************************
    // Items
    override fun selectItems(seminar_id:Int){
        seminaryItemList.clear()
        if(seminar_id==1) seminaryItemList.addAll(ItemsHardcodeSeminary1())
        else if(seminar_id==2)  seminaryItemList.addAll(ItemsHardcodeSeminary2())
        else if(seminar_id==3)  seminaryItemList.addAll(ItemsHardcodeSeminary3())
